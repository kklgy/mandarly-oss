package com.mandarly.boot.module.infra.controller.admin.codegen;
...
import com.mandarly.boot.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.mandarly.boot.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.mandarly.boot.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.mandarly.boot.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.mandarly.boot.module.infra.convert.codegen.CodegenConvert;
...
import com.mandarly.boot.module.infra.service.codegen.CodegenService;
...
import static com.mandarly.boot.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static com.mandarly.boot.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "mandarly"),
