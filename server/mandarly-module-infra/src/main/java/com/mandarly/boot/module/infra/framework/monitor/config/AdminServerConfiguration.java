package com.mandarly.boot.module.infra.framework.monitor.config;
 ...
 * 安全配置独立于 {@link com.mandarly.boot.framework.security.config.MandarlyWebSecurityConfigurerAdapter}，
