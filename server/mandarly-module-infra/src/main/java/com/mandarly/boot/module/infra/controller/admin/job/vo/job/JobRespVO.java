package com.mandarly.boot.module.infra.controller.admin.job.vo.job;
...
import com.mandarly.boot.module.infra.enums.DictTypeConstants;
...
public class JobRespVO {
    ...
    @Schema(description = "处理器的参数", example = "mandarly")
