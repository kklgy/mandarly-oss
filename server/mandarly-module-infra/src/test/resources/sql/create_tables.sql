...
CREATE TABLE IF NOT EXISTS "infra_api_error_log" (
    ...
    "exception_class_name" varchar(512) not null default '',
    "exception_file_name" varchar(512) not null default '',
    "exception_method_name" varchar(512) not null default '',
    "exception_line_number" integer not null default 0,
