...
import com.mandarly.boot.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "mandarly.tracer", value = "enable", matchIfMissing = true)
public class MandarlyTracerAutoConfiguration {
