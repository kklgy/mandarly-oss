package com.mandarly.boot.framework.web.config;
...
import com.mandarly.boot.framework.web.core.filter.CacheRequestBodyFilter;
import com.mandarly.boot.framework.web.core.filter.DemoFilter;
import com.mandarly.boot.framework.web.core.handler.GlobalExceptionHandler;
import com.mandarly.boot.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class MandarlyWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "mandarly.demo", havingValue = "true")
