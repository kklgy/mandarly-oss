package com.mandarly.boot.framework.jackson.config;

import com.mandarly.boot.framework.common.util.json.JsonUtils;
import com.mandarly.boot.framework.common.util.json.databind.NumberSerializer;
import com.mandarly.boot.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.mandarly.boot.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class MandarlyJacksonAutoConfiguration {
