package com.mandarly.boot.framework.ratelimiter.config;

import com.mandarly.boot.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.mandarly.boot.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.mandarly.boot.framework.ratelimiter.core.keyresolver.impl.*;
...
public class MandarlyRateLimiterConfiguration {
