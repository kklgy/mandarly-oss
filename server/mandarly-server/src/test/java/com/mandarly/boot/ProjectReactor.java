...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.mandarly.boot";
    private static final String ARTIFACT_ID = "mandarly";
    private static final String PACKAGE_NAME = "com.mandarly.boot";
    private static final String TITLE = "Mandarly";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.mandarly.boot";
        String artifactIdNew = "mandarly";
        String packageNameNew = "com.mandarly.boot";
        String titleNew = "Mandarly";
        String projectBaseDirNew = "/tmp/mandarly-server-output"; // 路径不能含 mandarly 字样
