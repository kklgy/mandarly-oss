package com.mandarly.boot.module.system.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode SMS_CODE_SEND_FAILED = new ErrorCode(1_002_014_006, "短信发送失败，请稍后再试");
    ...
    // ========== App-auth (M2.5,1_002_100 ~ 1_002_199) ==========
    ErrorCode AUTH_INVALID_CREDENTIALS = new ErrorCode(1_002_100, "邮箱或密码不正确");
    ErrorCode AUTH_CODE_EXPIRED = new ErrorCode(1_002_101, "验证码已过期");
    ErrorCode AUTH_CODE_INVALID = new ErrorCode(1_002_102, "验证码不正确");
    ErrorCode AUTH_CODE_COOLDOWN = new ErrorCode(1_002_103, "请求过于频繁,请稍后再试");
    ErrorCode AUTH_EMAIL_EXISTS = new ErrorCode(1_002_104, "该邮箱已注册");
    ErrorCode AUTH_PHONE_EXISTS = new ErrorCode(1_002_105, "该手机号已注册");
    ErrorCode AUTH_USER_NOT_FOUND = new ErrorCode(1_002_106, "账号不存在");
    ErrorCode AUTH_USER_FROZEN = new ErrorCode(1_002_107, "账号已冻结,请联系客服");
    ErrorCode AUTH_REFERRAL_INVALID = new ErrorCode(1_002_108, "推荐码无效");
    ErrorCode AUTH_SOCIAL_NOT_CONFIGURED = new ErrorCode(1_002_109, "该登录方式暂不可用");
    ErrorCode AUTH_SOCIAL_FETCH_FAILED = new ErrorCode(1_002_110, "三方服务暂时不可用,请改用其他方式");
    ErrorCode AUTH_TOKEN_EXPIRED = new ErrorCode(1_002_111, "登录已过期");
    ErrorCode AUTH_REFRESH_TOKEN_INVALID = new ErrorCode(1_002_112, "刷新令牌已失效,请重新登录");
    ErrorCode AUTH_SMTP_NOT_CONFIGURED = new ErrorCode(1_002_113, "邮件服务未就位");
    ErrorCode AUTH_PASSWORD_WEAK = new ErrorCode(1_002_114, "密码不满足复杂度(至少 8 位,字母 + 数字)");
    ErrorCode AUTH_RATE_LIMIT_DAILY = new ErrorCode(1_002_115, "今日发送次数已达上限");
    ErrorCode AUTH_LOGIN_FAILED_LOCKED = new ErrorCode(1_002_116, "登录失败次数过多,请 15 分钟后再试");
    ErrorCode AUTH_IP_REGISTER_LIMIT = new ErrorCode(1_002_117, "注册请求过于频繁");
    ErrorCode AUTH_SOCIAL_ACCOUNT_CONFLICT = new ErrorCode(1_002_118, "该账号已绑定其他用户");
    ErrorCode AUTH_MAIL_SEND_FAILED = new ErrorCode(1_002_119, "邮件发送失败,请稍后再试");
    ErrorCode AUTH_MAINLAND_SMS_UNSUPPORTED = new ErrorCode(1_002_120, "大陆手机号暂不支持短信验证码，请使用邮箱注册或登录");
