package com.mandarly.boot.module.system.controller.admin.socail.vo.client;
...
import com.mandarly.boot.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "mandarly商城")
    ...
    @Schema(description = "客户端编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "WECHAT_WORK_CORP_ID_PLACEHOLDER")
