package com.mandarly.boot.module.system.dal.redis;
...
public interface RedisKeyConstants {
    ...
    /**
     * App 端 MEMBER 用户(user 表)的 role 字段缓存(M6 引入)
     * <p>
     * 用途:{@code @PreAuthorize("@ss.hasRole('teacher')")} 对 app 用户的桥接 —
     * admin 体系走 system_user_role,member 体系走 user.role 单字段。
     * <p>
     * KEY 格式:member_user_role:{userId}
     * VALUE 数据类型:String 单角色字符串(teacher / student / ...)
     */
    String MEMBER_USER_ROLE = "member_user_role";
