...
import com.mandarly.boot.module.system.controller.admin.sms.vo.channel.SmsChannelRespVO;
import com.mandarly.boot.module.system.controller.admin.sms.vo.channel.SmsChannelSaveReqVO;
import com.mandarly.boot.module.system.controller.admin.sms.vo.channel.SmsChannelSimpleRespVO;
import com.mandarly.boot.module.system.dal.dataobject.sms.SmsChannelDO;
import com.mandarly.boot.module.system.service.sms.SmsChannelService;
...
public class SmsChannelController {
    ...
    public CommonResult<PageResult<SmsChannelRespVO>> getSmsChannelPage(@Valid SmsChannelPageReqVO pageVO) {
        ...
        PageResult<SmsChannelRespVO> respPage = BeanUtils.toBean(pageResult, SmsChannelRespVO.class);
        respPage.getList().forEach(this::maskSecretFields);
    ...
    private void maskSecretFields(SmsChannelRespVO channel) {
        channel.setApiKey(mask(channel.getApiKey()));
        channel.setApiSecret(mask(channel.getApiSecret()));
    }
