package com.mandarly.boot.module.system.service.social;
...
import com.mandarly.boot.framework.common.util.cache.CacheUtils;
import com.mandarly.boot.framework.common.util.http.HttpUtils;
import com.mandarly.boot.framework.common.util.object.BeanUtils;
import com.mandarly.boot.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.mandarly.boot.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.mandarly.boot.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.mandarly.boot.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.mandarly.boot.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.mandarly.boot.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.mandarly.boot.module.system.dal.dataobject.social.SocialClientDO;
import com.mandarly.boot.module.system.dal.mysql.social.SocialClientMapper;
import com.mandarly.boot.module.system.dal.redis.RedisKeyConstants;
import com.mandarly.boot.module.system.enums.social.SocialTypeEnum;
import com.mandarly.boot.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.mandarly.boot.framework.common.util.collection.MapUtils.findAndThen;
import static com.mandarly.boot.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.mandarly.boot.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${mandarly.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${mandarly.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/mandarly-cloud/pulls/230
