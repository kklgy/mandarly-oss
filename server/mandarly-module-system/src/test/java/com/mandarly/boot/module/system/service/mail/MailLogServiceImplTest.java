...
public class MailLogServiceImplTest extends BaseDbUnitTest {
    ...
    @Test
    public void testUpdateMailSendResult_nullLogId_throws() {
        assertThrows(IllegalArgumentException.class,
                () -> mailLogService.updateMailSendResult(null, randomString(), null));
    }

    @Test
    public void testUpdateMailSendResult_notFound_throws() {
        assertThrows(IllegalStateException.class,
                () -> mailLogService.updateMailSendResult(randomLongId(), randomString(), null));
    }
