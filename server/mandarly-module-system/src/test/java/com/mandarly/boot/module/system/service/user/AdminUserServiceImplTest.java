...
import com.mandarly.boot.framework.common.enums.CommonStatusEnum;
import com.mandarly.boot.framework.common.exception.ServiceException;
import com.mandarly.boot.framework.common.pojo.PageResult;
import com.mandarly.boot.framework.common.util.collection.ArrayUtils;
import com.mandarly.boot.framework.common.util.collection.CollectionUtils;
...
import com.mandarly.boot.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.mandarly.boot.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.mandarly.boot.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.mandarly.boot.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.mandarly.boot.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.mandarly.boot.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import com.mandarly.boot.module.system.dal.dataobject.dept.DeptDO;
import com.mandarly.boot.module.system.dal.dataobject.dept.PostDO;
import com.mandarly.boot.module.system.dal.dataobject.dept.UserPostDO;
import com.mandarly.boot.module.system.dal.dataobject.tenant.TenantDO;
import com.mandarly.boot.module.system.dal.dataobject.user.AdminUserDO;
import com.mandarly.boot.module.system.dal.mysql.dept.UserPostMapper;
import com.mandarly.boot.module.system.dal.mysql.user.AdminUserMapper;
import com.mandarly.boot.module.system.enums.common.SexEnum;
import com.mandarly.boot.module.system.service.dept.DeptService;
import com.mandarly.boot.module.system.service.dept.PostService;
import com.mandarly.boot.module.system.service.oauth2.OAuth2TokenService;
import com.mandarly.boot.module.system.service.permission.PermissionService;
import com.mandarly.boot.module.system.service.tenant.TenantService;
...
import static com.mandarly.boot.framework.common.util.collection.SetUtils.asSet;
import static com.mandarly.boot.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.mandarly.boot.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.mandarly.boot.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.mandarly.boot.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.mandarly.boot.framework.test.core.util.AssertUtils.assertServiceException;
import static com.mandarly.boot.framework.test.core.util.RandomUtils.*;
import static com.mandarly.boot.module.system.enums.ErrorCodeConstants.*;
import static com.mandarly.boot.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("mandarlyyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("mandarlyyuanma");
        ...
        assertEquals("mandarlyyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("mandarlyyuanma"))).thenReturn("java");
